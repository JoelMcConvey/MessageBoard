                    ...
                    return (
                        <Message {...post} key={post.id}>
                            <div className="flex gap-4">
                                ...
                                <button onClick={() => deletePost(post.id)} className="text-red-700 flex items-center justify-center gap-2 py-2 text-sm"><BsTrash2Fill className="text-2xl" />Delete</button>
                            </div>
                        </Message>
                    )
                })}
